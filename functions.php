...
function custom_feature_edit( $wp_customize ) {
	$wp_customize->add_section(
		'featured_post_image_one_section',
		array(
	...
	$wp_customize->add_control(
		new WP_Customize_Cropped_Image_Control(
			$wp_customize,
			'footer_post_image_three_control',
			array(
	...
	$wp_customize->add_control(
		new WP_Customize_Cropped_Image_Control(
			$wp_customize,
			'footer_post_image_four_control',
			array(
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			$wp_customize,
			'features_post_content_one_control',
			array(
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			$wp_customize,
			'features_post_content_two_control',
			array(
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			$wp_customize,
			'features_post_content_three_control',
			array(
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			$wp_customize,
			'features_post_content_four_control',
			array(
